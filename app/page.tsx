      ...
      {loading ? (
        ...
        <div className="space-y-0">
          ...
          {activeTab === 'restaurants' && (
            <div className="space-y-0">
              {[
                { id: '1', name: 'Restaurant One', address: '123 Main St, Berlin' },
                { id: '2', name: 'Restaurant Two', address: '456 Side St, Berlin' },
                { id: '3', name: 'Restaurant Three', address: '789 Back St, Berlin' },
